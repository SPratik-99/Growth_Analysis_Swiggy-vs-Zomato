...
By mapping the monthly search index into the Indian fiscal calendar (April to March), we aggregated the search index into quarterly averages and merged these datasets into a master table to analyze operational trends and test if web search momentum acts as a leading indicator of forward business metrics.
